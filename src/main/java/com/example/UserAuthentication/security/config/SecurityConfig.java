...
//    }
    ...
    //Commented so login and token generation can be by-passed; To learn kafka
...
//                .username("user")
//                //Encoded value of "password"
//                .password("$2a$10$.mZjSWbhMKn/4EYY/Khc9u/2pQ5hBn.3rhbYCQphSIv15JF4SLUzy")
//                .roles("USER")
//                .build();
//
